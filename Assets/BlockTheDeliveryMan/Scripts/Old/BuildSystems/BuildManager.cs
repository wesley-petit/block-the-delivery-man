...
public class BuildManager : MonoBehaviour
{
	...
	public void BuildItemOn(IBuilder zone)
	{
		if (!_itemToBuild)
			return;
		...
		GameObject item = Instantiate(_itemToBuild.Prefab, zone.GetBuildPosition(), Quaternion.identity, transform);
		zone.Build(item, _itemToBuild.MoveDelivery);
